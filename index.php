...
<button class="codepro-custom-btn codepro-btn-6" target="blank" title="Nơi Nhập GiftCode VIP" onclick="window.open('/giftcode')"><span>Nhập GiftCode</span></button>
                        ...
                        <div class="panel panel-primary">
                                    <div class="table-responsive shadow">
                                        <table class="table table-striped table-bordered table-hover text-center">
                                          ...
                                          <?php
                $list_game = $MinhChien->get_list("SELECT * FROM `chanle` WHERE `id` <=2 ORDER BY id asc ");
                foreach($list_game as $row) { ?>
                                            <tbody role="alert" aria-live="polite" aria-relevant="all" id="phone-tablechung" class="">
                                                <tr>
                                                    ...
                                                    <td id="677">
                                                        <b id="nearzekdev" style="position: relative;"><?=chanle($row['data']);?></b>
                                                    </td>
                                                    <td id="677">
        ...
        document.write(a);
                                                            ...
                                                            <input class="form-control" type="text" id="noidung" placeholder="Chẵn Lẻ ( Nội Dung C or L )"><br>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div>
                                                            <button type="submit" id="chanle" class="btn btn-info">Xác Nhận</button>
                                                        </div>
                                                            </div>
                                                        </center>
                                                    </td>
                                        ...
                                        <table class="table table-striped table-bordered table-hover text-center">
                                            <thead>
                                                <tr role="row" class="bg-info">
                                                    ...
                                                    <th class="text-center text-white bg-info">MGD</th>
...
$(document).ready(function(){
		$('#chanle').click(function() {
		$('#chanle').html('Đang Xử Lý...').prop('disabled', true);
		var formData = {
            'noidung'       : $("#noidung").val(),
            'money'         : $("#money").val()
	    };
		$.post("/api/chanle", formData,
			function (data) {
			    if(data.status == 'error'){
				Swal.fire('Thông Báo', data.msg, data.status);
				$('#chanle').html('Thanh Toán').prop('disabled', false);
			    } else {
