...
<section class="col-lg-12 connectedSortable">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">GAME CHẴN LẺ</h3>
                </div>
                <div class="card-body">
                    <div class="card-body table-responsive p-0">
                        <table id="datatable1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                <?php 
  $MINHCHIEN = $MinhChien->query("SELECT * FROM `chanle` WHERE `id` <=2 ORDER BY id asc ");
...
{
    $idd = $_POST['id'];
    $game_chanle = $MinhChien->get_row("SELECT * FROM `chanle` WHERE `id` = '$idd' ");
  if(!$game_chanle)
  {
