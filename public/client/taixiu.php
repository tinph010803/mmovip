...
<button class="codepro-custom-btn codepro-btn-6" target="blank" title="Nơi Nhập GiftCode VIP" onclick="window.open('/giftcode')"><span>Nhập GiftCode</span></button>
                        ...
                        <div class="panel panel-primary">
                                    <div class="table-responsive shadow">
                                        <table class="table table-striped table-bordered table-hover text-center">
                                          ...
                                          <?php
                $list_game = $MinhChien->get_list("SELECT * FROM `taixiu` WHERE `id` <=2 ORDER BY id asc ");
        ...
        document.write(a);
                                                            ...
                                                            <input class="form-control" type="text" id="noidung" placeholder="Tài Xỉu ( Nội Dung T or X )"><br>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div>
                                                            <button type="submit" id="taixiu" class="btn btn-info">Xác Nhận</button>
                                                        </div>
                                                            </div>
                                                        </center>
                                                    </td>
...
$(document).ready(function(){
		...
		$('#taixiu').html('Đang Xử Lý...').prop('disabled', true);
		var formData = {
            'noidung'       : $("#noidung").val(),
            'money'         : $("#money").val()
	    };
		$.post("/api/taixiu", formData,
			function (data) {
			    if(data.status == 'error'){
				Swal.fire('Thông Báo', data.msg, data.status);
				$('#taixiu').html('Thanh Toán').prop('disabled', false);
			    } else {
