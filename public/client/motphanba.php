						...
						<div class="container-xxl" id="kt_content_container">
						    <div class="card shadow">
						        <div class="card-body shadow row bg-light">
						            <div>
						                <h1 class="text-center h1"><span style='font-weight:bold;font-style:italic;font-family:"Courier New";font-size:35px;'><span style='color:#FF0000;'>H</span><span style='color:#FF2A00;'>ệ</span> <span style='color:#FF7F00;'>T</span><span style='color:#FFAA00;'>h</span><span style='color:#FFD400;'>ố</span><span style='color:#FFFF00;'>n</span><span style='color:#D4FF00;'>g</span> <span style='color:#7FFF00;'>C</span><span style='color:#54FF00;'>h</span><span style='color:#2AFF00;'>ẵ</span><span style='color:#00FF00;'>n</span> <span style='color:#00FF55;'>L</span><span style='color:#00FF7F;'>ẻ</span> <span style='color:#00FFD4;'>U</span><span style='color:#00FEFF;'>y</span> <span style='color:#00A9FF;'>T</span><span style='color:#007FFF;'>í</span><span style='color:#0054FF;'>n</span> <span style='color:#0000FF;'>-</span> <span style='color:#5500FF;'>N</span><span style='color:#7F00FF;'>ạ</span><span style='color:#AA00FF;'>p</span> <span style='color:#FF00FE;'>R</span><span style='color:#FF00D4;'>ú</span><span style='color:#FF00AA;'>t</span> <span style='color:#FF0054;'>1</span><span style='color:#FF002A;'>s</span></span></h1>
						                <h1 class="text-center h1">CHẴN LẺ <a class="text-danger"><?=$MinhChien->site('tenweb');?></a> SIÊU CẤP CHẴN LẺ 2023</h1>
						                    <h3 class="text-center"><span style='font-weight:bold;font-family:"Trebuchet MS";font-size:22px;'><span style='color:#FF0000;'>U</span><span style='color:#F70105;'>y</span> <span style='color:#E70310;'>T</span><span style='color:#DF0516;'>í</span><span style='color:#D7061C;'>n</span> <span style='color:#C70927;'>L</span><span style='color:#BF0A2D;'>à</span><span style='color:#B70B32;'>m</span> <span style='color:#A70E3E;'>N</span><span style='color:#9F0F43;'>ê</span><span style='color:#971149;'>n</span> <span style='color:#881354;'>T</span><span style='color:#80155A;'>h</span><span style='color:#78165F;'>ư</span><span style='color:#701765;'>ơ</span><span style='color:#68196B;'>n</span><span style='color:#601A70;'>g</span> <span style='color:#501D7C;'>H</span><span style='color:#481E81;'>i</span><span style='color:#401F87;'>ệ</span><span style='color:#38218D;'>u</span> <span style='color:#282398;'>!</span></span></h3>
						                <div class="text-center">
                                        <b>Chú ý 🔞:</b> Mini game chỉ dành cho người <b>trên 18 tuổi</b>.
                                        </div>
                                        <h3 class="text-center"><audio controls>
    <source src="dev.mp3" type="audio/mpeg">
</audio></h3>
<style>
        :root{
    ...
    <script>
        ...
        checkbox_toggle.addEventListener('change', function(){
            ...
            document.body.classList.toggle('dark');
						                    ...
						                    <center>
						                    <a href="/" class="btn btn-info py-3 mt-2"><span style='font-weight:bold;'><span style='color:#FFAE0D;'>Chẵn Lẻ</span></span></a>
						                    <a href="/chanle2" class="btn btn-info py-3 mt-2"><span style='font-weight:bold;'><span style='color:#FFAE0D;'>Chẵn Lẻ 2</span></span></a>
						                    <a href="/taixiu" class="btn btn-info py-3 mt-2"><span style='font-weight:bold;'><span style='color:#FFAE0D;'>Tài Xỉu</span></span></a>
						                    <a href="/taixiu2" class="btn btn-info py-3 mt-2"><span style='font-weight:bold;'><span style='color:#FFAE0D;'>Tài Xỉu 2</span></span></a>
						                    <a href="/motphanba" class="btn btn-info py-3 mt-2"><span style='font-weight:bold;'><span style='color:#FFAE0D;'>1 Phần 3</span></span></a>
						                    <a href="/xien" class="btn btn-info py-3 mt-2"><span style='font-weight:bold;'><span style='color:#FFAE0D;'>Xiên</span></span></a>
						                    <a href="/tong3so" class="btn btn-info py-3 mt-2"><span style='font-weight:bold;'><span style='color:#FFAE0D;'>Tổng 3 Số</span></span></a>
						                    <br>
                                            <!--CHỨC NĂNG THÊM-->
<br>
<button class="codepro-custom-btn codepro-btn-6" target="blank" title="Nơi Nhập GiftCode VIP" onclick="window.open('/giftcode')"><span>Nhập GiftCode</span></button>
						                    </center>
						            </div>
							<!-- GAME -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover text-center">
                                            <thead>
                                                <tr role="row" class="bg-info">
                                                    <th class="text-center text-white bg-inf"><b>NỘI DUNG CHƠI</b></th>
                                                    <th class="text-center text-white bg-inf"><b>SỐ CUỐI MGD</b></th>
                                                    <th class="text-center text-white bg-inf"><b>SỐ TIỀN NHẬN</b></th>
                                                </tr>
                                            </thead>
                                          <?php
                $list_game = $MinhChien->get_list("SELECT * FROM `motphanba` WHERE `id` ORDER BY id asc ");
                foreach($list_game as $row) { ?>
                                            <tbody role="alert" aria-live="polite" aria-relevant="all" id="phone-tablechung" class="">
                                                <tr>
                                                    <td id="677">
                                                        <b id="sdt" style="position: relative;"><?=$row['noidung'];?></b> 
                </svg></a>
                                                    </td>
                                                    <td id="677">
                                                        <b id="nearzekdev" style="position: relative;"><?=motphanba($row['data']);?></b>
                                                    </td>
                                                    <td id="677">
                                                        <b id="nearzekdev" style="position: relative;"><?=$row['tyle'];?></b>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                    ...
                                    <div class="d-inline-flex align-items-center justify-content-center">
                                        ...
                                        <b><span style='color:#FF00FE;'>=</span></b>
                                        <h5 class="mx-2 my-0"><span class="badge badge-success">Tiền đặt</span>
                                        </h5>
                                        <b><span style='color:#FF00FE;'>X</span></b>
                                        <h5 class="mx-2 my-0"><span class="badge badge-success">Tỉ lệ</span></h5>
                                    </div>
                                </div>
                                            </div></br></br>
                                                <div>
                                                    <a  href="<?=$MinhChien->site('contacttele');?>" class="btn btn-success py-3 mt-2">Hỗ trợ Telegram</a>
                                                    <a  href="<?=$MinhChien->site('contactzalo');?>" class="btn btn-warning py-3 mt-2">Hỗ trợ Zalo</a> 
                                                </div> 
                                        </div>
                                    </div>
                                    <!-- CHƠI -->
                        ...
                        <div class="panel panel-primary">
                                    <div class="table-responsive shadow">
                                        <table class="table table-striped table-bordered table-hover text-center">
                                            <thead>
                                                <tr role="row" class="bg-info">
                                                    <th class="text-center text-white bg-info">START GAME</th>
                                                </tr>
                                            </thead>
                                            <th class="text-center text-red bg-info"><span style='font-weight:bold;'><span style='color:#ff0008;'>Your Wallet Balance: </span></span> <?=tien($MinhChien->users('money'));?></th>
                                                </tr>
                                            </thead>
                                            <tbody role="alert" aria-live="polite" aria-relevant="all" id="phone-tablechung" class="">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="form-label" for="exampleInputEmail1">Nhập Nội Dung Chơi</label>
                                                            <h4 class="form-label" for="exampleInputEmail1"><span style='font-weight:bold;'><span style='color:#c43da2;'>Có Khả Năng Ra Số Cuối Là: </span></span> <script>
        var a = Math.floor(Math.random() * 10);
        document.write(a);
    </script></h4>
                                                            <input class="form-control" type="text" id="noidung" placeholder="1 Phần 3 ( Nội Dung N1 or N2 or N3 or N0 )"><br>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label" for="exampleInputEmail1">Số Tiền</label>
                                                            <input class="form-control" type="number" id="money" placeholder="1.000"><br>
                                                        </div>
                                                        <div>
                                                            <button type="submit" id="motphanba" class="btn btn-info">Xác Nhận</button>
                                                        </div>
                                                            </div>
                                                        </center>
                                                    </td>
                                    ...
                                    <!-- LỊCH SỬ CHƠI -->
                                <div class="col-md-12 mt-6 text-center cl">
                        <div class="panel panel-primary">
                            <h4 class="text-center card-title">
                                        <img src="https://upanh.cf/9wwxrx6gb9.png" style="width: 30px"> <b>Lịch Sử
                                            Thắng</b>
                                    </h4>
                                    <div class="table-responsive shadow">
                                        <table class="table table-striped table-bordered table-hover text-center">
                                            <thead>
                                                <tr role="row" class="bg-info">
                                                    <th class="text-center text-white bg-info">STT</th>
                                                    <th class="text-center text-white bg-info">TRANS_ID</th>
                                                    <th class="text-center text-white bg-info">NỘI DUNG</th>
                                                    <th class="text-center text-white bg-info">SỐ TIỀN</th>
                                                    <th class="text-center text-white bg-info">TIỀN NHẬN</th>
                                                    <th class="text-center text-white bg-info">GAME</th>
                                                    <th class="text-center text-white bg-info">TRẠNG THÁI</th>
                                                    <th class="text-center text-white bg-info"></th>
                                                </tr>
                                            </thead>
                                         <?php
                                                $i = 1;
                                                $list_mua = $MinhChien->get_list("SELECT * FROM `lichsuchoi` WHERE `username` = '".$MinhChien->users('username')."' ORDER BY id desc LIMIT 0, 10 ");
                                                ...
                                                <td class="text-center"><?=tien($row['tiennhan']);?></td>
...
$(document).ready(function(){
		$('#motphanba').click(function() {
		$('#motphanba').html('Đang Xử Lý...').prop('disabled', true);
		var formData = {
            'noidung'       : $("#noidung").val(),
            'money'         : $("#money").val()
	    };
		$.post("/api/motphanba", formData,
			function (data) {
			    if(data.status == 'error'){
				Swal.fire('Thông Báo', data.msg, data.status);
				$('#motphanba').html('Thanh Toán').prop('disabled', false);
			    } else {
