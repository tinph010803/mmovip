...
<button class="codepro-custom-btn codepro-btn-6" target="blank" title="Nơi Nhập GiftCode VIP" onclick="window.open('/giftcode')"><span>Nhập GiftCode</span></button>
                        ...
                        <div class="panel panel-primary">
                                    <div class="table-responsive shadow">
                                        <table class="table table-striped table-bordered table-hover text-center">
                                          ...
                                          <?php
                $list_game = $MinhChien->get_list("SELECT * FROM `taixiu` WHERE `id` >=3 ORDER BY id asc ");
                foreach($list_game as $row) { ?>
                                            <tbody role="alert" aria-live="polite" aria-relevant="all" id="phone-tablechung" class="">
                                                <tr>
                                                    ...
                                                    <td id="677">
                                                        <b id="nearzekdev" style="position: relative;"><?=taixiu($row['data']);?></b>
                                                    </td>
                                                    <td id="677">
        ...
        document.write(a);
                                                            ...
                                                            <input class="form-control" type="text" id="noidung" placeholder="Tài Xỉu 2 ( Nội Dung T2 or X2 )"><br>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label" for="exampleInputEmail1">Số Tiền</label>
                                                            <input class="form-control" type="number" id="money" placeholder="5.000 - 50.000"><br>
                                                        </div>
                                                        <div>
                                                            <button type="submit" id="taixiu2" class="btn btn-info">Xác Nhận</button>
                                                        </div>
                                                            </div>
                                                        </center>
                                                    </td>
...
$(document).ready(function(){
		$('#taixiu2').click(function() {
		$('#taixiu2').html('Đang Xử Lý...').prop('disabled', true);
		var formData = {
            'noidung'       : $("#noidung").val(),
            'money'         : $("#money").val()
	    };
		$.post("/api/taixiu2", formData,
			function (data) {
			    if(data.status == 'error'){
				Swal.fire('Thông Báo', data.msg, data.status);
				$('#taixiu2').html('Thanh Toán').prop('disabled', false);
			    } else {
